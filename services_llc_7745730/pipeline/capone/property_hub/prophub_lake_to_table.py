...
list   = [['OneView_CapitalOne_Property_3626.csv', 'OneView_CapitalOne_Property_3626', 'capitalone_custom_property_3626'],
          ['OVCPServices.csv','OVCPServices','capitalone_custom_ovcpservices']
         ]
for source in list:
